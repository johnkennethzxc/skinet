...
namespace API.Controllers
{
    ...
    public class OrdersController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IReadOnlyList<OrderDto>>> GetOrdersForUser() //Order
        {
            var email = HttpContext.User.RetrieveEmailFromPrincipal();
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<OrderToReturnDto>> GetOrderByIdForUser(int id) //Order
        {
            var email = HttpContext.User.RetrieveEmailFromPrincipal();
